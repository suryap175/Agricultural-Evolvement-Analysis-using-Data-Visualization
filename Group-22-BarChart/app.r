...
# Load data
top_8_emiss <- read.csv('C:\\Users\\surps\\OneDrive\\Desktop\\MS-DAE\\Spring 23\\Com Viz\\Homework and Assignments\\Project 1\\Group-22-BarChart\\sort.csv', header=T, na.strings = "")
top_8_emiss
#top_8_emiss <- head(arrange(emiss, desc(total_emissions)), 8)
#top_8_emiss
